...
var navZucchiniPancake = document.getElementById('nav-zucchini-pancake');
var navButtermilkBiscuit = document.getElementById('nav-buttermilk-biscuit');
var navChocolateCake = document.getElementById('nav-chocolate-cake');
...
navZucchiniPancake.addEventListener('click', navOnClickHandler);
navZucchiniPancake.addEventListener('click', navOnClickHandler2);

navButtermilkBiscuit.addEventListener('click', navOnClickHandler);
navButtermilkBiscuit.addEventListener('click', navOnClickHandler2);

navChocolateCake.addEventListener('click', navOnClickHandler);
navChocolateCake.addEventListener('click', navOnClickHandler2);
